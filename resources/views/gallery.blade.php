...
@section('breadcrumb')
    @include('layouts.breadcrumb', $items = [
        ['url' => route('site.gallery'), 'label' => "گالری"]
    ])
@endsection
    ...
    <section class="container">
        ...
        <div class="gg-container">
            <div class="gg-box" id="heightWidth">
                <img class="radius15" src="{{ asset('Img/gallery-2.jpg') }}" alt="">
                <img class="radius15" src="{{ asset('Img/gallery-3.jpg') }}" alt="">
                <img class="radius15" src="{{ asset('Img/gallery-1.jpg') }}" alt="">
                <img class="radius15" src="{{ asset('Img/gallery-4.jpg') }}" alt="">
                <img class="radius15" src="{{ asset('Img/gallery-5.jpg') }}" alt="">
                <img class="radius15" src="{{ asset('Img/gallery-3.jpg') }}" alt="">
                <img class="radius15" src="{{ asset('Img/gallery-6.jpg') }}" alt="">
                <img class="radius15" src="{{ asset('Img/gallery-7.jpg') }}" alt="">
            </div>
        </div>
    </section>
@endsection
