                ...
                <div class="item">
                    <div class="card-body mb-3 text-center">
                        <a href="page-shop.html">
                            <img class="img-fluid" src="{{ asset('Img/product-4.jpg') }}" alt="product_image">
                        </a>
                        <div>
                ...
                <div class="col-lg-7 pl-lg-5">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex flex-row align-items-center">
                            <img src="{{ asset('Img/profile.jpg') }}" class="img-fluid rounded-circle ml-3 pic55"
                                 alt="profile">
                            <div class="py-2">
                            ...
                            <div class="item">
                                <div
                                    ...
                                    <img src="{{ asset('Img/profile.jpg') }}"
                                         class="img-fluid pic155 p-1 rounded-circle ml-lg-5" alt="profile"/>

                                    <div class="m-2">
                                        <p> این یک نوشته آزمایشی است که به طراحان و برنامه نویسان کمک میکند تا این
                                            عزیزان با
                                            بهره گیری از این نوشته تستی و آزمایشی بتوانند نمونه تکمیل شده از پروژه و طرح
                                            خودشان را به کارفرما نمایش دهند.
                                        </p>
