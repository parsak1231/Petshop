        ...
        <div class="container">
            ...
            <div class="row d-flex align-items-center pt-lg-5">
                        ...
                        <form class="contact-form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <input type="text" name="first_name" class="form-control mb-2" placeholder="نام">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    <input type="tel" name="phone" class="form-control mb-2" placeholder="شماره موبایل"
                                ...
                                <div class="form-group col-md-6 d-flex justify-content-start">
                                    <input type="submit" class="btn btn-lightorng login-btn" value="ثبت نام"/>
                                </div>
                                <div class="form-group col-md-6 d-flex justify-content-end">
                                    <span>قبلا ثبت نام کرده اید؟<a class="reset-pass" href="{{ route('login.form') }}">وارد شوید</a></span>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="col-lg-5 d-flex align-items-center order-1 order-lg-2">
                    <img src="{{ asset('Img/login_pic.png') }}" class="img-fluid wapp" alt="sign up picture"/>
                </div>
            </div>
        </div>
    </section>
