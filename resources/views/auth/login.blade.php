        ...
        <div class="container">
            ...
            <div class="row d-flex align-items-center pt-lg-5">
                        ...
                        <form class="contact-form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 d-flex justify-content-start align-items-center">
                                    <input type="submit" class="btn btn-lightorng login-btn" value="ورود"/>
                                </div>
                                <div class="form-group col-md-6 d-flex justify-content-end">
                                    <a href="{{ route('register.form') }}" class="register-btn py-3 radius55"
                                       style="margin-left: 19px">ثبت نام</a>
                                </div>
                            </div>
                ...
                <div class="col-lg-5 d-flex align-items-center order-1 order-lg-2">
                    <img src="{{ asset('Img/login_pic.png') }}" class="img-fluid wapp" alt="login picture"/>
                </div>
