<head>
    <title>@yield('title', 'صفحه اصلی - دمو 1')</title>
    <meta charset="UTF-8">
                ...
                <div class="container p_relative h86">
                    ...
                    <div class="m_login d-flex">
                        ...
                        <div class="login px-4 py-2 radius55 d-flex align-items-center hide-on-mobile">
                            ...
                            @else
                                <form action="{{ route('logout') }}" method="POST" style="display: flex; align-items: center; padding: 0; margin: 0; border: none; background: none;">
                                    @csrf
                                    <button type="submit" class="mr-2 d-flex align-items-center" style="background: none; border: none; color: white; cursor: pointer; padding: 0; font: inherit;">
