                    ...
                    <div class="d-flex align-items-center my-3">
                        <svg width="22" height="26" viewBox="0 0 22 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                  ...
                                  stroke="#FFB500" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <p class="mr-2">آدرس : استان تهران، شهر پردیس، میدان امام خمینی، خیابان خلیج فارس شمالی، پلاک ۱۰</p>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div class="d-flex align-items-center my-3">
                            <svg width="22" height="21" viewBox="0 0 22 21" fill="none"
                                ...
                                <path d="M13.353 4.54297C15.124 4.88697 16.508 6.27197 16.853 8.04297" stroke="#FFB500"
                                      stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="d-flex align-items-center my-3 mx-3">
                            ...
                            <p class="mr-2">parsakavian2008@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
