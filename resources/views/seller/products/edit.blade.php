            ...
            <div class="col-sm-12" style="direction: rtl">
                <div class="card">
                    <div class="card-header">
                        <h4>فرم بروزرسانی محصول</h4>
                    </div>
                    <div class="card-body">
                        <form class="validate-me" id="validate-me" enctype="multipart/form-data"
                              action="{{ route('seller.products.update', $product->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-6">
                                    <img src="{{ asset($product->image) }}" alt="تصویر محصول"
                                         class="mt-2" style="width:200px;height: 100px"/>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-lg-4 col-form-label text-lg-end">
